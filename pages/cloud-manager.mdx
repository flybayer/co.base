...
If you are configured to use GitHub on the app, the deployment have a prompt to create a deploy workflow. The manager writes it to your codebase and prompts you to commit and push it. It also specifies the GitHub secrets that you must add for the action to operate properly.
