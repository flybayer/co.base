...
Eric is a self-taught entrepreneur and software engineer with 10+ years of experience building web and mobile apps.

Born in silicon valley, Eric has been cursed with the optimism that software and technology can make the world a better place. He had an early interest in robotics and filmmaking, but thanks to free time and a late-90's internet connection, he learned to build websites for fun. After dropping out from UC Davis with robotic startup ambitions, Eric realized that his most marketable skill is the one developed on the side: software engineering.

After building a successful software engineering career, Eric now is focused on software that provides social impact. This includes Aven, whose mission is to make software development dramatically more approachable.

### Open Source

#### Aven

This project is fully [open source](/sky-site), and it serves to demonstrate how web and mobile apps can be built.
...
However, the quality was low, so Eric partnered with the Expo team on a new solution, who maintained the most popular competing library. Eric built the initial version of React Navigation with the help of Adam Miskiewicz from Expo.
...
Initially built by Eric's intern Frank Li, Docusaurus eventually found strong ownership in the open source community, and continues to thrive.
