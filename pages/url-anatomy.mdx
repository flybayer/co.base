...
The last part of the URL is special because the browser does not send this value to the server.

The fragment is usually used for [document links](/document-links), to jump to an element on the page once it has loaded.
