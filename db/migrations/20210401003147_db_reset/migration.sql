...
-- CreateIndex
CREATE UNIQUE INDEX "Node.immutableChecksum_unique" ON "Node"("immutableChecksum");

-- CreateIndex
CREATE UNIQUE INDEX "TypeLink.fromId_typeId_toId_unique" ON "TypeLink"("fromId", "typeId", "toId");

-- CreateIndex
CREATE UNIQUE INDEX "NameLink.onId_name_unique" ON "NameLink"("onId", "name");
...
-- AddForeignKey
ALTER TABLE "TypeLink" ADD FOREIGN KEY ("fromId") REFERENCES "Node"("id") ON DELETE CASCADE ON UPDATE CASCADE;

-- AddForeignKey
ALTER TABLE "TypeLink" ADD FOREIGN KEY ("typeId") REFERENCES "Node"("id") ON DELETE CASCADE ON UPDATE CASCADE;

-- AddForeignKey
ALTER TABLE "TypeLink" ADD FOREIGN KEY ("toId") REFERENCES "Node"("id") ON DELETE CASCADE ON UPDATE CASCADE;

-- AddForeignKey
ALTER TABLE "NameLink" ADD FOREIGN KEY ("onId") REFERENCES "Node"("id") ON DELETE CASCADE ON UPDATE CASCADE;

-- AddForeignKey
ALTER TABLE "NameLink" ADD FOREIGN KEY ("toId") REFERENCES "Node"("id") ON DELETE CASCADE ON UPDATE CASCADE;
