  ...
  return (
    <>
      <SitemapSection>
        <InnerWidth>
          ...
          <FooterSection>
            ...
            <FooterLink href="/docs/rest-websocket-api">
              REST + WebSocket API
            </FooterLink>
      ...
      <SocialSection>
        <div>
          <LogoLink
            href={"https://github.com/AvenCloud"}
            target="_blank"
            color={GITHUB_COLOR}
          >
          ...
          <LogoLink
            href={"https://twitter.com/Aven_Cloud"}
            target="_blank"
            color={TWITTER_COLOR}
          >
      ...
      <LegalSection>
        ...
        <LegalLink href="/legal/code-of-conduct">
          Aven.io Code of Conduct
        </LegalLink>
      </LegalSection>
    </>
  );
